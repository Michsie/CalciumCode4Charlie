function [events,CsingleEvents,Ntrace,onsetTimingRemovedEvents,stdRemovedEvents,minDurRemovedEvents,EventEnds,stdThreshMatrix]=findCalciumEventsOld(meanROIActivity,stdMultiplier,slopeThresh,OnsetDist,minDur,BaselineDur,PeakSearchDur)
